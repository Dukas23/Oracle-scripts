...
BEGIN
  ...
  IF table_exists > 0 THEN
    EXECUTE IMMEDIATE 'DROP TABLE DUMMY CASCADE CONSTRAINTS';
  END IF;
END;
/
...
BEGIN
  ...
  INTO table_exists
  FROM user_tables
  WHERE table_name = 'LOGEMP';

  IF table_exists > 0 THEN
    EXECUTE IMMEDIATE 'DROP TABLE LOGEMP CASCADE CONSTRAINTS';
  END IF;
END;
/
...
BEGIN
  ...
  INTO table_exists
  FROM user_tables
  WHERE table_name = 'AUDITEMP';

  IF table_exists > 0 THEN
    EXECUTE IMMEDIATE 'DROP TABLE AUDITEMP CASCADE CONSTRAINTS';
  END IF;
END;
/

rem =======================================================
rem Create tables and pupulate with data
rem =======================================================
